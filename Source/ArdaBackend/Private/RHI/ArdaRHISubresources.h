...
namespace arda
{
    ...
    public:
        ...
        public:
            ...
            FArdaTextureSubresource operator*() const noexcept { return mCurrent; }
            bool operator!=(FSentinel) const noexcept { return !mbDone; }
        ...
        FIterator begin() const noexcept { return FIterator(mRange); }
        FSentinel end() const noexcept { return {}; }
