...
namespace arda
{
	...
	FArdaShaderTypeRegistration::FArdaShaderTypeRegistration(const char* Name,
	    ...
	    FArdaShaderType::FShouldCompilePermutationFunction ShouldCompilePermutationFunction,
	    FArdaShaderType::FModifyCompilationEnvironmentFunction ModifyCompilationEnvironmentFunction)
	{
