...
namespace arda
{
	namespace
	{
		...
		FArdaShaderDirectoryStatus& Publish(FDirectoryRegistry& Registry, FArdaShaderDirectoryStatus Status)
		{
		...
		FArdaShaderDirectoryStatus RegistryMutationStatus(FDirectoryRegistry& Registry)
		{
