...
namespace arda
{
     ...
     */
	[[nodiscard]] FArdaShaderDirectoryStatus BeginShaderDirectoryRegistryUse();
     ...
     */
	[[nodiscard]] FArdaShaderDirectoryStatus ScanAndFreezeShaderSourceDirectoriesForBackend();
