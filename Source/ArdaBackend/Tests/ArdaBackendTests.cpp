...
namespace
{
	...
	class FCollectingDiagnosticCallback final : public arda::IArdaDiagnosticCallback
	{
	public:
	...
	class FTestDeviceProvider final : public arda::IArdaExternalDeviceProvider
	{
	public:
	...
	class FTestResourceProvider final : public arda::IArdaExternalResourceProvider
	{
	public:
