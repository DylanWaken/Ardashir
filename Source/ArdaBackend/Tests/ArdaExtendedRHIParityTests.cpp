...
namespace
{
	class FExtendedDiagnosticCallback final : public arda::IArdaDiagnosticCallback
	{
	public:
	...
	public:
		~FExtendedBackendCleanup()
		{
			...
			static_cast<void>(arda::ConfigureBackend(arda::FArdaBackendConfiguration{}));
		}
	};
	...
	void VerifyVulkanOpacityMicromapLifecycleAndStateParity()
	{
		...
		const FMicromapTriangle Triangle = {0, 0, static_cast<uint16_t>(EArdaRHIOpacityMicromapFormat::TwoState)};
	...
	using FCapabilityPredicate = bool (*)(const arda::FArdaRHICapabilities&);
...
#define ARDA_CAPABILITY(Name, Expression, Probe)                                                                       \
	{Name,                                                                                                             \
	    ...
	    ECapabilityProbe::Probe,                                                                                       \
	    #Expression}

	const std::vector<FCapabilityConformanceCase>& GetCapabilityConformanceCases()
	{
...
#undef ARDA_CAPABILITY
	...
	class FArdaRHICapabilityConformanceTest : public testing::TestWithParam<FCapabilityConformanceCase>
	{
	};
}
