...
namespace arda
{
	...
	public:
		...
		using FParameterMetadataFunction = const FArdaShaderParameterMetadata* (*)();

		/** Function that decides whether one permutation should be compiled. */
		using FShouldCompilePermutationFunction = bool (*)(const FArdaShaderPermutationParameters&);

		/** Function that adds permutation and shader-class compilation definitions. */
		using FModifyCompilationEnvironmentFunction = void (*)(const FArdaShaderPermutationParameters&,
	...
	public:
		...
		FArdaShaderTypeRegistration(const char* Name,
		    ...
		    FArdaShaderType::FShouldCompilePermutationFunction ShouldCompilePermutationFunction = nullptr,
		    FArdaShaderType::FModifyCompilationEnvironmentFunction ModifyCompilationEnvironmentFunction = nullptr);
	...
	struct TArdaShaderPermutationTraits<ShaderClass, std::void_t<typename ShaderClass::FPermutationDomain>>
	{
