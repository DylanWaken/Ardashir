...
namespace arda
{
	...
	public:
         ...
         */
		FArdaShaderParameterMetadata(const char* Name,
		    size_t Size,
		    size_t Alignment,
		...
		[[nodiscard]] uint64_t GetLayoutHash() const noexcept
		{
			return mLayoutHash;
		}

		/** @return Validation status for this metadata. */
		[[nodiscard]] const FArdaShaderStructStatus& GetStatus() const noexcept
		{
			return mStatus;
		}
         ...
         */
		[[nodiscard]] const FArdaShaderParameterMember* FindMember(const eastl::string& Name) const noexcept;
         ...
         */
		[[nodiscard]] const FArdaShaderParameterMember* FindFlattenedMember(const eastl::string& Path,
         ...
         */
		void GetFlattenedMembers(eastl::vector<FArdaFlattenedShaderParameterMember>& OutMembers) const;
         ...
         */
		[[nodiscard]] FArdaShaderStructStatus BuildBindingSetDesc(const void* Parameters,
         ...
         */
		[[nodiscard]] FArdaShaderStructStatus CreateBindingSet(arda::IArdaRHIDevice& Device,
         ...
         */
		[[nodiscard]] FArdaShaderStructStatus ApplyPushConstants(arda::IArdaRHICommandList& CommandList,
		    const void* Parameters,
         ...
         */
		[[nodiscard]] FArdaShaderStructStatus GetPushConstantData(const void* Parameters,
	...
	[[nodiscard]] FArdaShaderStructStatus ApplyShaderPushConstants(arda::IArdaRHICommandList& CommandList,
	    const ParameterType& Parameters,
	    const arda::FArdaRHIBindingLayoutDesc& Layout)
	{
		return ParameterType::GetStaticMetadata().ApplyPushConstants(CommandList, &Parameters, Layout);
	}
}
...
private:                                                                                                               \
	...
	static void FArdaAppendShaderMembers(FArdaShaderNextMemberId##MemberName,                                          \
...
#define ARDA_BEGIN_SHADER_PARAMETER_STRUCT(StructType)                                                                 \
	...
	private:                                                                                                           \
		...
		static void FArdaAppendShaderMembers(FArdaShaderFirstMemberId,                                                 \
...
public:                                                                                                                \
	...
	{                                                                                                                  \
		...
		{                                                                                                              \
			...
			return ::arda::FArdaShaderParameterMetadata(FArdaShaderStructName,                                         \
			    sizeof(FArdaShaderThisStruct),                                                                         \
			    alignof(FArdaShaderThisStruct),                                                                        \
			    eastl::move(Members));                                                                                 \
		}();                                                                                                           \
		return Metadata;                                                                                               \
	}                                                                                                                  \
...
#define ARDA_SHADER_PARAMETER_VALUE(CppType, MemberName)                                                               \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::Value,                                     \
...
#define ARDA_SHADER_TEXTURE_SRV(MemberName, Slot, Space, Visibility)                                                   \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::TextureSRV,                                \
	    ::arda::EArdaRHIBindingType::TextureSRV,                                                                       \
...
#define ARDA_SHADER_TEXTURE_UAV(MemberName, Slot, Space, Visibility)                                                   \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::TextureUAV,                                \
...
#define ARDA_SHADER_BUFFER_SRV(MemberName, Slot, Space, Visibility)                                                    \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::BufferSRV,                                 \
...
#define ARDA_SHADER_BUFFER_UAV(MemberName, Slot, Space, Visibility)                                                    \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::BufferUAV,                                 \
...
#define ARDA_SHADER_CONSTANT_BUFFER(MemberName, Slot, Space, Visibility)                                               \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::ConstantBuffer,                            \
...
#define ARDA_SHADER_UNIFORM_BUFFER(MemberName, Slot, Space, Visibility)                                                \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::UniformBuffer,                             \
	    ::arda::EArdaRHIBindingType::ConstantBuffer,                                                                   \
	    ::arda::FArdaRHIUniformBufferRef,                                                                              \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
	    Space,                                                                                                         \
	    Visibility)
...
#define ARDA_SHADER_SAMPLER(MemberName, Slot, Space, Visibility)                                                       \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::Sampler,                                   \
	    ::arda::EArdaRHIBindingType::Sampler,                                                                          \
	    ::arda::FArdaRHISamplerRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
	    Space,                                                                                                         \
	    Visibility)
...
#define ARDA_SHADER_ACCELERATION_STRUCTURE(MemberName, Slot, Space, Visibility)                                        \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::AccelerationStructure,                     \
	    ::arda::EArdaRHIBindingType::RayTracingAccelStruct,                                                            \
	    ::arda::FArdaRHIAccelStructRef,                                                                                \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
	    Space,                                                                                                         \
	    Visibility)
...
#define ARDA_SHADER_TEXTURE_SRV_ARRAY(MemberName, Slot, Space, Count, Visibility)                                      \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::TextureSRV,                                       \
	    ::arda::EArdaRHIBindingType::TextureSRV,                                                                       \
	    ::arda::FArdaRHITextureRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_TEXTURE_UAV_ARRAY(MemberName, Slot, Space, Count, Visibility)                                      \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::TextureUAV,                                       \
	    ::arda::EArdaRHIBindingType::TextureUAV,                                                                       \
	    ::arda::FArdaRHITextureRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_BUFFER_SRV_ARRAY(MemberName, Slot, Space, Count, Visibility)                                       \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::BufferSRV,                                        \
	    ::arda::EArdaRHIBindingType::StructuredBufferSRV,                                                              \
	    ::arda::FArdaRHIBufferRef,                                                                                     \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_BUFFER_UAV_ARRAY(MemberName, Slot, Space, Count, Visibility)                                       \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::BufferUAV,                                        \
	    ::arda::EArdaRHIBindingType::StructuredBufferUAV,                                                              \
	    ::arda::FArdaRHIBufferRef,                                                                                     \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_SAMPLER_ARRAY(MemberName, Slot, Space, Count, Visibility)                                          \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::Sampler,                                          \
	    ::arda::EArdaRHIBindingType::Sampler,                                                                          \
	    ::arda::FArdaRHISamplerRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_ACCELERATION_STRUCTURE_ARRAY(MemberName, Slot, Space, Count, Visibility)                           \
	ARDA_INTERNAL_SHADER_PARAMETER(::arda::EArdaShaderParameterKind::AccelerationStructure,                            \
	    ::arda::EArdaRHIBindingType::RayTracingAccelStruct,                                                            \
	    ::arda::FArdaRHIAccelStructRef,                                                                                \
	    MemberName,                                                                                                    \
	    Slot,                                                                                                          \
...
#define ARDA_SHADER_PUSH_CONSTANTS(CppType, MemberName, Slot, Space, Visibility)                                       \
	ARDA_INTERNAL_SHADER_PARAMETER_SCALAR(::arda::EArdaShaderParameterKind::PushConstants,                             \
...
private:                                                                                                               \
	...
	{                                                                                                                  \
		FArdaAppendShaderMembers(FArdaShaderMemberId##MemberName{}, Members);                                          \
		Members.push_back({#MemberName,                                                                                \
		    ::arda::EArdaShaderParameterKind::NestedStruct,                                                            \
		    ::arda::EArdaRHIBindingType::TextureSRV,                                                                   \
		    0,                                                                                                         \
		    0,                                                                                                         \
		    1,                                                                                                         \
