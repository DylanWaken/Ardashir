...
namespace arda
{
	...
	public:
		...
		[[nodiscard]] virtual bool Present(FArdaNativeObject BackBuffer, uint32_t Width, uint32_t Height) = 0;
	...
	public:
         ...
         */
		[[nodiscard]] virtual FArdaNativeObject CreateVulkanSurface(FArdaNativeObject VulkanInstance,
	...
	public:
		...
		[[nodiscard]] virtual eastl::shared_ptr<IArdaCustomPresent> GetCustomPresent() const
		{
			return {};
		}
     ...
     */
	[[nodiscard]] EArdaInitializeResult InitializeBackendForPresentation(IArdaWindowSurface& WindowSurface,
	    uint32_t Width,
	    uint32_t Height,
