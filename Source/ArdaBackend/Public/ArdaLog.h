...
namespace arda
{
	...
	public:
         ...
         */
		explicit FArdaLogCategory(const char* name,
     ...
     */
	using FArdaLogOutput = void (*)(const FArdaLogRecord& record, void* userData) noexcept;
     ...
     */
	void Logf(const FArdaLogCategory& category,
...
#define ARDA_DECLARE_LOG_CATEGORY_EXTERN(CategoryName) extern ::arda::FArdaLogCategory CategoryName
...
#define ARDA_DEFINE_LOG_CATEGORY(CategoryName, DefaultVerbosity)                                                       \
	::arda::FArdaLogCategory CategoryName(#CategoryName, ::arda::EArdaLogVerbosity::DefaultVerbosity)
...
#define ARDA_DEFINE_LOG_CATEGORY_NAMED(CategoryName, ScopeName, DefaultVerbosity)                                      \
	::arda::FArdaLogCategory CategoryName(ScopeName, ::arda::EArdaLogVerbosity::DefaultVerbosity)
...
#define ARDA_LOG(CategoryName, Verbosity, ...)                                                                         \
	...
	{                                                                                                                  \
		...
		constexpr auto ArdaLogVerbosity = ::arda::EArdaLogVerbosity::Verbosity;                                        \
		if (ArdaLogCategory.IsEnabled(ArdaLogVerbosity))                                                               \
		{                                                                                                              \
			::arda::Logf(ArdaLogCategory,                                                                              \
			    ArdaLogVerbosity,                                                                                      \
			    __FILE__,                                                                                              \
