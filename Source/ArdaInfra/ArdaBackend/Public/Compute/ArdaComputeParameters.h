...
namespace arda
{
	...
	public:
		...
		FArdaComputeParameterMetadata(const char* Name,
		    size_t Size,
		    size_t Alignment,
		...
		[[nodiscard]] const eastl::vector<FArdaComputeParameterMember>& GetMembers() const noexcept
		{
			return mMembers;
		}
         ...
         */
		[[nodiscard]] FArdaRHIStatus Enumerate(const void* Parameters,
	...
	private:
		void EnumerateInternal(const uint8_t* Root,
		    size_t Offset,
...
#define ARDA_BEGIN_COMPUTE_PARAMETER_STRUCT(StructType)                                                                \
	...
	private:                                                                                                           \
		...
		static void FArdaAppendComputeMembers(FArdaComputeFirstMemberId,                                               \
		    eastl::vector<::arda::FArdaComputeParameterMember>&)                                                       \
		{                                                                                                              \
		}                                                                                                              \
...
private:                                                                                                               \
	...
	static void FArdaAppendComputeMembers(FArdaComputeNextMemberId##MemberName,                                        \
	...
	{                                                                                                                  \
		...
		Members.push_back({#MemberName,                                                                                \
		    ...
		    Kind,                                                                                                      \
		    Access,                                                                                                    \
		    offsetof(FArdaComputeThisStruct, MemberName),                                                              \
		    sizeof(DeclaredType),                                                                                      \
		    alignof(ElementType),                                                                                      \
		    Count,                                                                                                     \
		    sizeof(ElementType),                                                                                       \
...
public:                                                                                                                \
	...
	{                                                                                                                  \
		...
		{                                                                                                              \
			...
			return ::arda::FArdaComputeParameterMetadata(FArdaComputeStructName,                                       \
			    sizeof(FArdaComputeThisStruct),                                                                        \
			    alignof(FArdaComputeThisStruct),                                                                       \
			    eastl::move(Members));                                                                                 \
		}();                                                                                                           \
		return Metadata;                                                                                               \
	}                                                                                                                  \
...
#define ARDA_COMPUTE_PARAMETER(CppType, MemberName)                                                                    \
	ARDA_INTERNAL_COMPUTE_PARAMETER(::arda::EArdaComputeParameterKind::Value,                                          \
...
#define ARDA_COMPUTE_BUFFER(MemberName, Access)                                                                        \
	ARDA_INTERNAL_COMPUTE_PARAMETER(::arda::EArdaComputeParameterKind::Buffer,                                         \
	    Access,                                                                                                        \
...
#define ARDA_COMPUTE_TEXTURE(MemberName, Access)                                                                       \
	ARDA_INTERNAL_COMPUTE_PARAMETER(::arda::EArdaComputeParameterKind::Texture,                                        \
	    Access,                                                                                                        \
...
#define ARDA_COMPUTE_PARAMETER_STRUCT(StructType, MemberName)                                                          \
	ARDA_INTERNAL_COMPUTE_PARAMETER(::arda::EArdaComputeParameterKind::NestedStruct,                                   \
	    ::arda::EArdaComputeAccess::Read,                                                                              \
	    StructType,                                                                                                    \
	    StructType,                                                                                                    \
	    MemberName,                                                                                                    \
...
#define ARDA_COMPUTE_PARAMETER_ARRAY(CppType, MemberName, Count)                                                       \
	ARDA_INTERNAL_COMPUTE_ARRAY(::arda::EArdaComputeParameterKind::Value,                                              \
	    ::arda::EArdaComputeAccess::Read,                                                                              \
	    CppType,                                                                                                       \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
...
#define ARDA_COMPUTE_BUFFER_ARRAY(MemberName, Count, Access)                                                           \
	ARDA_INTERNAL_COMPUTE_ARRAY(::arda::EArdaComputeParameterKind::Buffer,                                             \
	    Access,                                                                                                        \
	    ::arda::FArdaComputeBufferParameter,                                                                           \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
...
#define ARDA_COMPUTE_TEXTURE_ARRAY(MemberName, Count, Access)                                                          \
	ARDA_INTERNAL_COMPUTE_ARRAY(::arda::EArdaComputeParameterKind::Texture,                                            \
	    Access,                                                                                                        \
	    ::arda::FArdaComputeTextureParameter,                                                                          \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
...
#define ARDA_COMPUTE_PARAMETER_STRUCT_ARRAY(StructType, MemberName, Count)                                             \
	ARDA_INTERNAL_COMPUTE_ARRAY(::arda::EArdaComputeParameterKind::NestedStruct,                                       \
	    ::arda::EArdaComputeAccess::Read,                                                                              \
	    StructType,                                                                                                    \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
