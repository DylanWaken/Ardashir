...
namespace arda
{
     ...
     */
	[[nodiscard]] FArdaShaderDirectoryStatus AddShaderSourceDirectory(const std::filesystem::path& RealDirectory,
     ...
     * @return Registration status.
     */
	[[nodiscard]] FArdaShaderDirectoryStatus AddShaderSourceDirectoryMapping(const eastl::string& VirtualRoot,
	...
	[[nodiscard]] eastl::vector<FArdaShaderSourceDirectory> EnumerateShaderSourceDirectories();

	/** @return All files in the frozen shader source manifest. */
	[[nodiscard]] eastl::vector<FArdaShaderSourceFile> EnumerateShaderSourceFiles();
     ...
     */
	[[nodiscard]] FArdaShaderDirectoryStatus ResolveVirtualShaderSource(const eastl::string& VirtualPath,
