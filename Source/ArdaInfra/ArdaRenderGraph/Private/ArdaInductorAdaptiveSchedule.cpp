...
namespace arda
{
	namespace
	{
		...
		eastl::vector<FArdaGraphNodeHandle> CriticalOrder(const FArdaDependencyGraph::FArdaImpl& Graph,
		...
		FArdaRHIStatus UpdateLifetimes(const FArdaDependencyGraph::FArdaImpl& Graph,
	...
	TArdaRHIResult<FArdaInductorAdaptiveScheduleResult> TuneArdaInductorSchedule(
	    const FArdaDependencyGraph::FArdaImpl& Snapshot,
