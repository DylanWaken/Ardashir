...
namespace arda
{
	...
	inline constexpr uint32_t WriteMask = static_cast<uint32_t>(arda::EArdaRHIResourceState::UnorderedAccess) |
	    ...
	    static_cast<uint32_t>(arda::EArdaRHIResourceState::OpacityMicromapWrite);
	...
	inline constexpr uint32_t GraphicsOnlyMask = static_cast<uint32_t>(arda::EArdaRHIResourceState::RenderTarget) |
	    ...
	    static_cast<uint32_t>(arda::EArdaRHIResourceState::ShadingRateSource) |
	    ...
	    static_cast<uint32_t>(arda::EArdaRHIResourceState::PixelShaderResource);
