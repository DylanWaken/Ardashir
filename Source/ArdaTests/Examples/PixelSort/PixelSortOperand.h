...
// normal C++ renderer and the nvcc translation unit; CUDA SDK types stay in .cu.
...
namespace arda
{
	...
	struct FPixelSortColor
	{
		uint8_t mR, mG, mB, mA;
	};

// One field list generates both sides of the launch ABI:
//   FPixelSortParameters        : retained RHI texture views + host scalar values
//   FPixelSortParameters::FCuda : CUDA surface handles + copied scalar values
