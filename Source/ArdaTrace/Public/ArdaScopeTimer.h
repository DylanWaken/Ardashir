...
namespace arda
{
	...
	public:
		...
		~FArdaScopeTimer() noexcept
		{
			...
			arda::RecordTraceScope(mNameId, mScopeId, mParentScopeId, mStartNanoseconds, EndNanoseconds);
		}
...
#define ARDA_SCOPE_TIMER()                                                                                             \
	::arda::FArdaScopeTimer ARDA_PRIVATE_JOIN_TRACE_NAMES(ArdaScopeTimer, __LINE__)(                                   \
