...
#define ARDA_PRIVATE_JOIN_TRACE_NAMES(Prefix, Suffix) ARDA_PRIVATE_JOIN_TRACE_NAMES_INNER(Prefix, Suffix)

/** Records a numeric counter sample under a stable string label. */
#define ARDA_TRACE_COUNTER(Name, Value)                                                                                \
	do                                                                                                                 \
	{                                                                                                                  \
		static const ::arda::FArdaTraceName ARDA_PRIVATE_JOIN_TRACE_NAMES(ArdaTraceCounterName, __LINE__)(Name);       \
		::arda::RecordTraceCounter(ARDA_PRIVATE_JOIN_TRACE_NAMES(ArdaTraceCounterName, __LINE__),                      \
...
#define ARDA_TRACE_MARKER(Name)                                                                                        \
	do                                                                                                                 \
	{                                                                                                                  \
		static const ::arda::FArdaTraceName ARDA_PRIVATE_JOIN_TRACE_NAMES(ArdaTraceMarkerName, __LINE__)(Name);        \
		::arda::RecordTraceMarker(ARDA_PRIVATE_JOIN_TRACE_NAMES(ArdaTraceMarkerName, __LINE__));                       \
	} while (false)
#else
