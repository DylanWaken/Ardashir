...
namespace arda
{
    ...
    inline constexpr uint32_t WriteMask =
        static_cast<uint32_t>(arda::EArdaRHIResourceState::UnorderedAccess) |
    ...
    inline constexpr uint32_t CopyMask =
        static_cast<uint32_t>(arda::EArdaRHIResourceState::CopySource) |
        static_cast<uint32_t>(arda::EArdaRHIResourceState::CopyDest);
    ...
    [[nodiscard]] inline bool IsUAVState(
        arda::EArdaRHIResourceState State) noexcept
    {
        return (State & arda::EArdaRHIResourceState::UnorderedAccess) !=
            arda::EArdaRHIResourceState::Unknown;
    }

    [[nodiscard]] inline arda::EArdaRHIResourceState NormalizeStateForPipeline(
    ...
    [[nodiscard]] inline arda::EArdaRHIResourceState NormalizeInitialState(
        arda::EArdaRHIResourceState State) noexcept
    {
