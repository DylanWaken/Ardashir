...
namespace arda
{
	...
	{
		return static_cast<EARDGPassFlags>(static_cast<uint16_t>(Left) | static_cast<uint16_t>(Right));
	}
	...
	[[nodiscard]] constexpr EARDGResourceFlags operator|(EARDGResourceFlags Left, EARDGResourceFlags Right) noexcept
	{
		return static_cast<EARDGResourceFlags>(static_cast<uint8_t>(Left) | static_cast<uint8_t>(Right));
	}
	...
	constexpr EARDGResourceFlags& operator|=(EARDGResourceFlags& Left, EARDGResourceFlags Right) noexcept
	{
		Left = Left | Right;
		return Left;
	}
	...
	/** Returns whether Value contains every flag in Required. */
	[[nodiscard]] constexpr bool HasAllFlags(EARDGResourceFlags Value, EARDGResourceFlags Required) noexcept
	{
		return (Value & Required) == Required;
	}
