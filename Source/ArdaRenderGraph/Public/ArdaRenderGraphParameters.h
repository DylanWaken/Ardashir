...
namespace arda
{
	...
	public:
         ...
         */
		FARDGParameterMetadata(const char* Name,
		    size_t Size,
		    size_t Alignment,
		      ...
		      mMembers(eastl::move(Members))
		{
			...
			{
				if (Member.mName == nullptr || Member.mElementCount == 0 || Member.mElementStride == 0 ||
				    Member.mOffset > mSize || Member.mSize > mSize - Member.mOffset)
				{
					ARDA_CHECK_MSG("Invalid render-graph parameter member metadata.");
				}

				if (Member.mType == EARDGParameterType::NestedStruct && Member.mNestedMetadata == nullptr)
				{
         ...
         */
		void Enumerate(const void* Parameters,
		    ...
		    bool bIncludeNestedContainers = false) const
		{
			...
			EnumerateInternal(static_cast<const std::byte*>(Parameters),
			    eastl::string(),
			    Visitor,
	...
	private:
		void EnumerateInternal(const std::byte* Parameters,
		    ...
		    bool bIncludeNestedContainers) const
		{
			for (const FARDGParameterMember& Member : mMembers)
			{
				const eastl::string MemberPath = Prefix.empty() ? Member.mName : Prefix + "." + Member.mName;

				for (size_t ElementIndex = 0; ElementIndex < Member.mElementCount; ++ElementIndex)
				{
					const void* Value = Parameters + Member.mOffset + ElementIndex * Member.mElementStride;
					eastl::string ElementPath = MemberPath;
					if (Member.mElementCount != 1)
					{
						char ElementIndexText[32];
						std::snprintf(ElementIndexText, sizeof(ElementIndexText), "%zu", ElementIndex);
						ElementPath += "[";
					...
					if (Member.mType == EARDGParameterType::NestedStruct)
					{
						...
						Member.mNestedMetadata->EnumerateInternal(static_cast<const std::byte*>(Value),
						    ElementPath,
						    Visitor,
						    bIncludeNestedContainers);
					}
...
private:                                                                                                               \
	...
	static void FARDGAppendMembers(FARDGNextMemberId##MemberName,                                                      \
...
#define ARDG_BEGIN_PARAMETER_STRUCT(StructType)                                                                        \
	...
	private:                                                                                                           \
		...
		static void FARDGAppendMembers(FARDGFirstMemberId, eastl::vector<::arda::FARDGParameterMember>&)               \
		{                                                                                                              \
		}                                                                                                              \
...
public:                                                                                                                \
	...
	{                                                                                                                  \
		...
		{                                                                                                              \
			...
			return ::arda::FARDGParameterMetadata(FARDGStructName,                                                     \
...
#define ARDG_PARAMETER(CppType, MemberName)                                                                            \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::Value,                                                         \
	    CppType,                                                                                                       \
	    MemberName,                                                                                                    \
	    arda::EArdaRHIResourceState::Unknown)
...
#define ARDG_PARAMETER_ARRAY(CppType, MemberName, Count)                                                               \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::Value,                                                   \
	    CppType,                                                                                                       \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::Unknown)
...
#define ARDG_TEXTURE(MemberName)                                                                                       \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::Texture,                                                       \
...
#define ARDG_TEXTURE_ARRAY(MemberName, Count)                                                                          \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::Texture,                                                 \
	    ::arda::FARDGTextureRef,                                                                                       \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::ShaderResource)
...
#define ARDG_BUFFER(MemberName)                                                                                        \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::Buffer,                                                        \
	    ::arda::FARDGBufferRef,                                                                                        \
	    MemberName,                                                                                                    \
	    arda::EArdaRHIResourceState::ShaderResource)
...
#define ARDG_BUFFER_ARRAY(MemberName, Count)                                                                           \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::Buffer,                                                  \
	    ::arda::FARDGBufferRef,                                                                                        \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::ShaderResource)
...
#define ARDG_TEXTURE_SRV(MemberName)                                                                                   \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::TextureShaderResourceView,                                     \
...
#define ARDG_TEXTURE_SRV_ARRAY(MemberName, Count)                                                                      \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::TextureShaderResourceView,                               \
	    ::arda::FARDGTextureSRVRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::ShaderResource)
...
#define ARDG_TEXTURE_UAV(MemberName)                                                                                   \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::TextureUnorderedAccessView,                                    \
...
#define ARDG_TEXTURE_UAV_ARRAY(MemberName, Count)                                                                      \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::TextureUnorderedAccessView,                              \
	    ::arda::FARDGTextureUAVRef,                                                                                    \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::UnorderedAccess)
...
#define ARDG_BUFFER_SRV(MemberName)                                                                                    \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::BufferShaderResourceView,                                      \
...
#define ARDG_BUFFER_SRV_ARRAY(MemberName, Count)                                                                       \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::BufferShaderResourceView,                                \
	    ::arda::FARDGBufferSRVRef,                                                                                     \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::ShaderResource)
...
#define ARDG_BUFFER_UAV(MemberName)                                                                                    \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::BufferUnorderedAccessView,                                     \
...
#define ARDG_BUFFER_UAV_ARRAY(MemberName, Count)                                                                       \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::BufferUnorderedAccessView,                               \
	    ::arda::FARDGBufferUAVRef,                                                                                     \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::UnorderedAccess)
...
#define ARDG_TEXTURE_ACCESS(MemberName)                                                                                \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::TextureAccess,                                                 \
...
#define ARDG_TEXTURE_ACCESS_ARRAY(MemberName, Count)                                                                   \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::TextureAccess,                                           \
	    ::arda::FARDGTextureAccess,                                                                                    \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::Unknown)
...
#define ARDG_BUFFER_ACCESS(MemberName)                                                                                 \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::BufferAccess,                                                  \
...
#define ARDG_BUFFER_ACCESS_ARRAY(MemberName, Count)                                                                    \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::BufferAccess,                                            \
	    ::arda::FARDGBufferAccess,                                                                                     \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::Unknown)
...
#define ARDG_ACCEL_STRUCT_ACCESS(MemberName)                                                                           \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::AccelStructAccess,                                             \
...
#define ARDG_UNIFORM_BUFFER(MemberName)                                                                                \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::UniformBuffer,                                                 \
...
#define ARDG_UNIFORM_BUFFER_ARRAY(MemberName, Count)                                                                   \
	ARDG_INTERNAL_PARAMETER_ARRAY(::arda::EARDGParameterType::UniformBuffer,                                           \
	    ::arda::FARDGUniformBufferRef,                                                                                 \
	    MemberName,                                                                                                    \
	    Count,                                                                                                         \
	    arda::EArdaRHIResourceState::ConstantBuffer)
...
#define ARDG_PARAMETER_STRUCT(StructType, MemberName) ARDG_INTERNAL_NESTED_PARAMETER(StructType, MemberName)
...
#define ARDG_RENDER_TARGET_BINDING_SLOTS(MemberName)                                                                   \
	ARDG_INTERNAL_PARAMETER(::arda::EARDGParameterType::RenderTargetBindingSlots,                                      \
